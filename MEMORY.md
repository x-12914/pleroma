...
- ⬜ Security (USER ACTION, needs root): apply nginx security headers (now in deploy/nginx-pleroma.conf) to the live cert-managed config + add HSTS to the 443 block + reload nginx. I can't edit /etc/nginx as non-root.
